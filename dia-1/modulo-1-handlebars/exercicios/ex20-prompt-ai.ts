/**
 * Exercicio 20: Templates para Prompts de AI (Capstone)
 *
 * Aplique tudo que aprendeu para criar prompts dinamicos e reutilizaveis.
 * Este exercicio conecta Handlebars com AI Engineering - a base do Modulo 2.
 * Execute: npx tsx exercicios/ex20-prompt-ai.ts
 */
...
console.log('Dica: veja a solucao em solucoes/ex20-prompt-ai.ts');
