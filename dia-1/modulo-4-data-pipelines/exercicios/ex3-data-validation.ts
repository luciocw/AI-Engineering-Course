/**
 * Exercicio 3: Data Validation com Zod
 *
 * Valide dados com Zod e detecte tentativas de XSS/injection.
 * Execute: npx tsx exercicios/ex3-data-validation.ts
 */
...
console.log('Dica: veja a solucao em solucoes/ex3-data-validation.ts');
