/**
 * Exercicio 7: Parametros da API (temperature, max_tokens, stop_sequences)
 *
 * Experimente como os parametros afetam as respostas do Claude.
 * Execute: npx tsx exercicios/ex7-parametros.ts
 */
...
console.log('Dica: veja a solucao em solucoes/ex7-parametros.ts');
