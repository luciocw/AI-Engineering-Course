/**
 * Exercicio 7: Chain-of-Thought Prompting
 *
 * Compare abordagem direta vs CoT vs CoT estruturado em calculo complexo.
 * Execute: npx tsx exercicios/ex7-chain-of-thought.ts
 */
...
console.log('Dica: veja a solucao em solucoes/ex7-chain-of-thought.ts');
