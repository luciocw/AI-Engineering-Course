/**
 * Exercicio 14: Error Handling em Tool Use
 *
 * Implemente retries, timeouts e degradacao graceful.
 * Execute: npx tsx exercicios/ex14-error-handling.ts
 */
...
console.log('Dica: veja a solucao em solucoes/ex14-error-handling.ts');
