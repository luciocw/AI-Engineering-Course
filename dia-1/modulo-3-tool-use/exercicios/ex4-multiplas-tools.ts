/**
 * Exercicio 4: Multiplas Tools
 *
 * Disponibilize 3 tools e deixe Claude escolher qual usar.
 * Execute: npx tsx exercicios/ex4-multiplas-tools.ts
 */
...
// Tool 1: calculadora — operacoes matematicas (do ex2)
...
console.log('Dica: veja a solucao em solucoes/ex4-multiplas-tools.ts');
